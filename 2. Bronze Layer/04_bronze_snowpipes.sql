/*
snowpipe creation : Snowpipes enable continuous and automatic
                    ingestion of new files from S3 into Bronze tables.
                    AUTO_INGEST = TRUE triggers the pipe when new files
                    are uploaded to the configured S3 stage.
                    
csv     : csv_raw_pipe
json    : json_raw_pipe
parquet : parquet_pipe
*/
